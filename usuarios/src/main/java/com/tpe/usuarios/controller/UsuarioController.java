...
import com.tpe.usuarios.DTO.DTOAuth;
...
import com.tpe.usuarios.service.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<JwtToken> autenticarse(@Valid @RequestBody DTOAuth auth){
    ...
    public ResponseEntity<DTOUsuario> registrarse(@Valid @RequestBody DTOUsuario usuario) throws Exception {
          DTOUsuario usuarioGuardado = this.service.guardar(usuario);
    ...
    @GetMapping("/validar")
    public ResponseEntity<ValidateTokenDTO> obtenerValidacion() {

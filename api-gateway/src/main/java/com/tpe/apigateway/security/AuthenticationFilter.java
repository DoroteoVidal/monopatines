...
import com.tpe.apigateway.DTO.DTOValidateToken;
...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    private List<String> excludedUrls = List.of( "usuarios/autenticar", "usuarios/registrarse");
        ...
        return (exchange, chain) -> {
            ...
            if(this.isSecured.test(request)) {
                return webClientBuilder.build().get()
                        .uri("http://localhost:8001/usuarios/validar")
                        .header(authHeader, bearerToken)
